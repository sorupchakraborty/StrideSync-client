            ...
            <tr {...headerGroup.getHeaderGroupProps()} key={headerGroup.id}>
              {headerGroup.headers.map((column) => (
                <th
                  ...
                  key={column.id}
                  className="px-4 py-3 text-gray-800 dark:text-white uppercase tracking-wider border border-gray-400 dark:border-gray-200 text-center bg-rose-100 dark:bg-gray-700"
                >
