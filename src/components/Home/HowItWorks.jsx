...
//             <div
//               key={index}
//               className="bg-rose-100 border border-rose-800 dark:bg-gray-800 rounded-lg shadow-md p-6 text-center"
//             >
...
const WhyJoinMarathon = () => {
  ...
  return (
    <section className="bg-gradient-to-r from-rose-50 to-rose-100 dark:from-gray-800 dark:to-gray-900 py-16 mt-12">
