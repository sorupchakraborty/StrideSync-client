        ...
        <section className="bg-gray-100 dark:bg-gray-900">
            <div className="py-10 md:py-16 max-w-7xl mx-auto px-4">
                ...
                <div className="flex justify-center items-center my-6">
                    <Link to="/marathons" className=" text-center text-white text-lg rounded-lg px-6 py-2 bg-rose-600 dark:text-rose-400 font-semibold mt-4 hover:underline">See More</Link>
                </div>
            </div>
        </section>
    );
