  ...
  const links = (
    <>
      <NavLink
        to="/"
        className={({ isActive }) =>
          `px-3 py-2 text-xs md:text-sm lg:text-md font-semibold rounded mr-2 ${isActive ? 'bg-rose-600 text-white' : 'bg-transparent dark:text-gray-200'}`
        }
      ...
      <div className="navbar max-w-7xl mx-auto">
        <div className="navbar-start items-center">
          ...
          >
            ...
            <span className="text-rose-700 dark:text-rose-500 italic">
              StrideSync
            </span>
          </h2>
        </div>
        ...
        <div className="navbar-end gap-2">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `px-3 py-2 text-xs md:text-sm lg:text-md font-semibold rounded ${isActive ? 'bg-rose-600 text-white' : 'bg-transparent dark:text-gray-200'}`
            }
          >
