        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8 justify-center items-center">
            {marathons.map((marathon) => (
                ...
                >
                    ...
                    {/* Title Section */}
                    <div className="p-4 text-center bg-rose-200">
                    ...
                    <div className="absolute bottom-0 left-0 w-full bg-rose-200 text-gray-500 dark:text-gray-100 transform translate-y-full group-hover:translate-y-0 transition-transform duration-300 p-6">
