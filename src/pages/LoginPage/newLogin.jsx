...
const LoginPage = () => {
    ...
    return (
        <div className="flex items-center justify-center my-6">
            <Helmet>
                <title>StrideSync | Login</title>
            </Helmet>
            <div className="w-full max-w-md p-8 space-y-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                {user ? (
                    <div className="">
                        <div className="p-4 text-center text-rose-600 bg-rose-100 rounded-md flex flex-col justify-center items-center gap-2">
                    ...
                    <div className="">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <button
                                ...
                                className="w-full flex justify-center items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-rose-500 rounded-md hover:bg-rose-600 focus:outline-none focus:ring-2 focus:ring-blue-400"
                            >
                                <FaGoogle />
