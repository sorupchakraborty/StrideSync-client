    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-100 py-10 px-6 lg:px-20">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="mb-4 text-lg">
          Welcome to StrideSync! By accessing or using our platform, you agree to
        ...
        <section className="mb-8">
          ...
          <p>
            By using StrideSync, you agree to comply with and be legally bound by
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            guardian to use our services. By using StrideSync, you represent and
        ...
        <section className="mb-8">
          ...
          <p>
            StrideSync is not liable for any direct, indirect, incidental,
        ...
        <section className="mb-8">
          ...
          <p>
            StrideSync may update these Terms of Service from time to time. Any
        ...
        <footer className="mt-8">
          <p>
            ...
            contact us at{" "}
            <a
              href="mailto:support@StrideSync.com"
              className="text-rose-500 hover:text-rose-400"
            >
              support@StrideSync.com
            </a>
            .
          </p>
        </footer>
